...
class Claude:
    ...
    def get_organisation_uuid(self):
        ...
        response = requests.get(url, headers=headers,impersonate="safari15_5", timeout=60)
    ...
    def create_new_conversation(self) -> None:
        ...
        response = requests.post(url,data=payload, headers=headers,impersonate="safari15_5", timeout=60)
    ...
    def get_answer(self,prompt):
        ...
        response = requests.post(url, headers=headers, data=payload,impersonate="chrome110", timeout=60)
